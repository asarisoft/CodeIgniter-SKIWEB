<div class="container container-about1" style="background: url('<?php echo base_url($active->img_url)?>') !important; background-size: cover !important; background-repeat: no-repeat !important;">
