	...
	<div class="row container-text container-text-general">
		...
		<div class="col-md-5 content-right">
			<ul class="list">
			    ...
			    <li class="detail1"><a class="table-content" href="<?php echo base_url('home/'.$value->page.'?id='.$value->id)?>"><span style="padding-right: 10px"><?php echo $value->title ?></span><span class="number"><?php echo $value->number ?></span></a></li>
			    <?php } } ?>
		    </ul> 
		</div>
	</div>
