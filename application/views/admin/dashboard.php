		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="panel panel-blue">
					...
					<div class="panel-body">
						...
						<li class="todo-list-item">
							...
							<li class="todo-list-item">
								<div class="checkbox">
									<input type="checkbox" id="checkbox" />
									<label for="checkbox">Save Basecamp</label>
								</div>
								<div class="pull-right action-buttons">
									<a href="#"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg></a>
									<a href="#" class="flag"><svg class="glyph stroked flag"><use xlink:href="#stroked-flag"></use></svg></a>
					...
					<div class="panel-footer">
						<div class="input-group">
							<input id="btn-input" type="text" class="form-control input-md" placeholder="Tambah new task" />
							<span class="input-group-btn">
								<button class="btn btn-info btn-md" id="btn-todo">Tambah</button>
							</span>
						</div>
					</div>
				</div>
	...
	<script type = 'text/javascript' src = "<?php echo base_url(); ?>js/chart-data.js"></script>
	<script type = 'text/javascript' src = "<?php echo base_url(); ?>js/easypiechart.js"></script>
	<script type = 'text/javascript' src = "<?php echo base_url(); ?>js/easypiechart-data.js"></script>
