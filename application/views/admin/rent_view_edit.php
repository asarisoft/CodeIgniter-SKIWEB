        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <h4 class="title_page"> Edit Rent <a class="btn btn-sm btn-info" 
                    style="float: right; background: red;" href="<?php echo base_url('rent/detail?id='.$rent->id) ?>" title="Preview" target="_blank"><i class="glyphicon glyphicon-eye-open"></i></a></h4>
                    <form action="<?php echo base_url('admin/rent/update')?>" id="form"  enctype="multipart/form-data" method="post" class="form-horizontal">
                        <div class="panel-body">
                            <input type="hidden" value="<?php echo $rent->id ?>" name="id"/> 
                            <input type="hidden" value="<?php echo $rent->file_name ?>" name="file_name"/> 
                            <input type="hidden" value="<?php echo $rent->img_url ?>" name="img_url"/>
                            <div class="form-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="subject" class="form-control" type="text" 
                                                value="<?php echo $rent->subject ?>" maxlength="80">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="agent_id" name="agent_id" class="form-control" type="hidden" 
                                                   value="<?php echo $rent->agent_id ?>">
                                            <input name="agent" class="form-control" type="text"
                                                   value="<?php echo $rent->agent_name ?>" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="price_text" class="form-control" type="text" 
                                                value="<?php echo $rent->price_text ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                             <select name="rent_button" class="form-control" >
                                                <option <?php if ($rent->rent_button == "Yes") echo "selected"; ?> value="Yes">Yes</option>
                                                <option <?php if ($rent->rent_button == "No") echo "selected"; ?> value="No">No</option>
                                            </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                             <select name="category" class="form-control" >
                                                <option <?php if ($rent->category == "Apartemen") echo "selected"; ?> value="Apartemen">Apartemen</option>
                                                <option <?php if ($rent->category == "Land") echo "selected"; ?> value="Land">Land</option>
                                                <option <?php if ($rent->category == "Houses") echo "selected"; ?> value="Houses">Houses</option>
                                                <option <?php if ($rent->category == "Others") echo "selected"; ?> value="Others">Others</option>
                                                <option <?php if ($rent->category == "Australia") echo "selected"; ?> value="Australia">Australia</option>
                                            </select>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                            ...
                                            <?php if(sizeof($tag) > 0): ?>
                                                <select name="tags[]" class="form-control" multiple="multiple">
                                                    <?php foreach($tag as $tg): ?>
                                                        <option 
                                                            <?php if(in_array ($tg['id'], $selected_renttag)) echo "selected"; ?> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <img src="<?php echo base_url($rent->img_url) ?>" class="img_thumb_edit"></i>
                                        </div>
                                ...
                                <div class="form-group" style="padding-left: 4px">
                                    <div class="col-md-12">
                                        <label class="control-label" style=" padding: 0;margin: 10px -18px;">
                                        Description</label>
                                        <textarea name="description" id="description" class="form-control" type="text" rows="10"><?php echo $rent->description ?></textarea>
                                                ...
                                                <?php if(sizeof($city) > 0): ?>
                                                    <select id="select1" class="form-control" name="city">
                                                        <?php foreach($city as $ct): ?>
                                                            <option 
                                                                <?php if ($rent->city == $ct['city']) echo "selected"; ?>
                                                ...
                                                <?php if(sizeof($area) > 0): ?>
                                                    <select name="area" id="select2" class="form-control" >
                                                        <?php foreach($area as $ar): ?>
                                                            <option 
                                                                <?php if ($rent->area == $ar['area']) echo "selected"; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="size_building" class="form-control" type="text" 
                                                    value="<?php echo $rent->size_building ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="orientation" class="form-control" type="text" 
                                                    value="<?php echo $rent->orientation ?>">
...
<!--                                          <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 <select name="price_level" class="form-control" >
                                                    <option <?php if ($rent->price_level == "< 1M") echo "selected"; ?> value="< 1M">1 bedroom</option>
                                                    <option <?php if ($rent->price_level == "1M - 2M") echo "selected"; ?> value="1 - 2M">1 - 2M</option>
                                                    <option <?php if ($rent->price_level == "2M - 3M") echo "selected"; ?> value="2 - 3M">2 - 3M</option>
                                                    <option <?php if ($rent->price_level == "> 3M") echo "selected"; ?> value="> 3M">> 3M</option>
                                                </select>
                                                <span class="help-block"></span>
                                            </div>
                                        </div> -->
